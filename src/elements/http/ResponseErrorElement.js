        ...
        return html`
          <section>
            ...
            <a
              ...
              target="_blank"
            >
              <anypoint-button emphasis="high" tabindex="-1" ?anypoint="${this.anypoint}">Tell me more</anypoint-button>
            </a>
            <a class="inherit" href="https://bugs.chromium.org/p/chromium/issues/detail?id=603104" target="_blank">
              <anypoint-button emphasis="high" tabindex="-1" ?anypoint="${this.anypoint}">See CR bug</anypoint-button>
            </a>
            <p class="error-code">${message}</p>
          </section>
        `;
